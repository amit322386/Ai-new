...
const Footer = () => {
  return (
    <footer className="px-6 bg-black md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
           <img  classNmae='h-9'src={assets.logo} alt="logo" />
            <p class="mt-6 text-sm">
                Experence the power of AI with QuickAI.
            </p>
        </div>
