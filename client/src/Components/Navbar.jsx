    ...
    <div className='fixed z-50 w-full backdrop-blur-2xl flex justify-between items-center py-3 px-4 sm:px-20 xl:px-32'>
      ...
      
      {
        user ? (
          ...
          <button onClick={() => openSignIn()} className='flex items-center gap-2 rounded-md text-sm cursor-pointer bg-primary text-white px-10 py-2.5'>Get started <ArrowRight className='w-4 h-4' /></button>
        )
      }
